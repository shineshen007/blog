...
## 数据准备
# data
![data](https://github.com/shineshen007/blog/blob/master/content/blog/NormAE/data.png?raw=true)  

# sample.info
![info](https://github.com/shineshen007/blog/blob/master/content/blog/NormAE/info.png?raw=true)  
...
## 训练模型
 ...
 当训练结束后，在`./RESULTS/train1`中将有以下4个文件：  
  ...
  ` python -m visdom.server `  来打开visdom服务
